...
<br><br>
	...
	<section>
			<table border="2">
				...
				$registro = $mysql->query("SELECT ID_TRATAMIENTO
				FROM tratamientos") or
				die($mysql->error);
...
<form action="consultar_tratamiento.php" method="post">
	
	<br><br>
		<div><br/>
			<label>ID TRATAMIENTO</label>
			<div>
				<input type="text" class="campos" name="ID_TRATAMIENTO" placeholder="NUMERO TRATAMIENTO a CONSULTAR" required />
			</div>
		</div>
