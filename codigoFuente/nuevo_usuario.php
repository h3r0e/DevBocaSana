...
?>
  ...
  <form method="post" action="nuevo_usuario_final.php">
	<p>
	<br><br><br>
	<div class="padre">
	
	<p>INTRODUZCA LAS CREDENCIALES DEL NUEVO USUARIO</p>
	</div>
	
	<br/><br/><br>
	INTRODUZCA EL NUEVO USUARIO: <br><input class= "campos" type = "text" name= "usuario"
	placeholder = "Introduzca el nuevo usuario." />
	</p>
	<br>
	<br>
	<p>
	ASIGNE UNA CONTRASEÑA AL NUEVO USUARIO: <br><input class= "campos" type = "password" name= "passwd"
