...
<head>
	...
	<title>INSERTAR-TRATAMIENTO</title>
</head>
...
?>			
	<form method="post" action="insertar_tratamiento.php">
		<div><br/>
		...
		<div><br/>
			...
			<div>
				<input type="text" class="campos" name="NOMBRE_TRATAMIENTO" placeholder="NOMBRE TRATAMIENTO" required />
			</div>
		</div>
		...
		<div><br/>
			<label>COSTE</label>
			<div>
				<input type="number" class="campos" name="COSTE" placeholder="COSTE" required />
			</div>
		</div>
