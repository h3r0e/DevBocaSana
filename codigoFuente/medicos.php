...
?>
  <form method="post">
	...
	<div class="hijo"> 
	<a href="./medicos0.php">
	<input class="boton_agenda" type="button" value="INSERTAR MEDICO"/>
	</a>
    </div>
	<br><br><br>
    ...
    <div class="hijo"> 
	<a href="./medicos1.php">
	<input class="boton_agenda" type="button" value="CONSULTAR MEDICOS"/>
	</a>
    </div>
	<br><br><br>
	
	<div class="hijo">
	<a href="./modificar/medicos2.php">
    <input class="boton_agenda" type="button" value="MODIFICAR MEDICOS"/>
    </a>
	</div>
	<br><br><br>
	<div class="hijo"> 
	<a href="./medicos3.php">
	<input class="boton_agenda" type="button" value="ELIMINAR MEDICOS"/>
    </a>
	</div>
