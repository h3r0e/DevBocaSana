...
?>			
	<form method="post" action="insertar_presupuestos.php">
		<div><br/>
			<label>ID PRESUPUESTO</label>
			<div>
				<input type="number" class="campos" name="ID_PRESUPUESTO" placeholder="ID PRESUPUESTO" required />
			</div>
		</div>
		...
		<div><br/>
			...
			<div>
				<input type="number" class="campos" name="ID_TRATAMIENTO" placeholder="ID TRATAMIENTO" required />
			</div>
		</div>
		...
		<div><br/>
			<label>MEDICO_NOMBRE</label>
			<div>
				<input type="text" class="campos" name="MEDICO_NOMBRE" placeholder="MEDICO_NOMBRE" required />
			</div>
		</div>
		...
		<div><br/>
			<label>DEUDA</label>
			<div>
				<input class="campos" name="DEUDA" placeholder="DEUDA" required />
			</div>
		</div>
		...
		<div><br/>
			<label>HORA</label>
			<div>
				<input type="time" class="campos" name="HORA" placeholder="HORA" required />
			</div>
		</div>
