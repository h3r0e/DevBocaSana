...
<form action="modificar_tratamiento.php" method="post">
	...
	Ingresar TRATAMIENTO Y EL COSTE a cambiar:<br/><br/>
	Ingrese TRATAMIENTO:<br>
	<input class= "campos" type = "text" name= "TRATAMIENTO"
	placeholder = "Ingrese TRATAMIENTO"/>	
	<br><br><br>
	Ingrese COSTE:<br>
	<input class= "campos" type = "text" name= "COSTE"
	placeholder = "Ingrese COSTE del tratamiento"/>	
	<br><br><br>
