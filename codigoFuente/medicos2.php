...
?>
<form action="modificar_medicos.php" method="post">
	
	<br><br><br>
	
	<div class="contenedor1">
	Ingresar FECHA Y HORA a cambiar de la cita de un paciente:<br/><br/>
	Ingrese FECHA:<br>
	<input class= "campos" type = "text" name= "FECHA"
	placeholder = "Ingrese DNI del paciente a consultar la agenda:"/>	
	<br><br><br>
	Ingrese HORA:<br>
