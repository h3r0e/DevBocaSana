...
<head>
	...
	<title>MODIFICAR PRESUPUESTOS</title>
</head>
...
<?php
	...
	$sql = "SELECT * FROM presupuestos WHERE ID_PRESUPUESTO = '$ID_PRESUPUESTO'";
...
?>
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="update_presupuestos.php" autocomplete="off">
				<div class="form-group">
					<label for="DEUDA" class="col-sm-2 control-label">DEUDA</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="DEUDA" name="DEUDA" placeholder="DEUDA" value="<?php echo $row['DEUDA']; ?>" required>
					</div>
				</div>
				
				<input type="hidden" id="ID_PRESUPUESTO" name="ID_PRESUPUESTO" value="<?php echo $row['ID_PRESUPUESTO']; ?>" />
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<a href="presupuestos2.php" class="btn btn-default">VOLVER</a>
