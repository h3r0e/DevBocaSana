...
<?php
	...
	$sql = "UPDATE medicos SET ESPECIALIDAD='$ESPECIALIDAD', DIRECCION='$DIRECCION', TELEFONO='$TELEFONO' WHERE NOMBRE_APELLIDO = '$NOMBRE_APELLIDO'";
