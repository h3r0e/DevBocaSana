...
<?php
	...
	$sql = "SELECT * FROM medicos WHERE NOMBRE_APELLIDO = '$NOMBRE_APELLIDO'";
...
?>
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="update_medicos.php" autocomplete="off">
				<div class="form-group">
					<label for="ESPECIALIDAD" class="col-sm-2 control-label">ESPECIALIDAD</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="ESPECIALIDAD" name="ESPECIALIDAD" placeholder="ESPECIALIDAD" value="<?php echo $row['ESPECIALIDAD']; ?>" required>
					</div>
				</div>
				
				<input type="hidden" id="NOMBRE_APELLIDO" name="NOMBRE_APELLIDO" value="<?php echo $row['NOMBRE_APELLIDO']; ?>" />
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<a href="medicos2.php" class="btn btn-default">VOLVER</a>
