...
<?php
	...
	if(!empty($_POST))
	{
		$valor = $_POST['campo'];
		if(!empty($valor)){
			$where = "WHERE ID_PRESUPUESTO LIKE '%$valor'";
		}
	}
	$sql = "SELECT * FROM presupuestos $where";
					...
					<tbody>
						<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
							<tr>
								...
								<td><a href="modificar_presupuestos.php?ID_PRESUPUESTO=<?php echo $row['ID_PRESUPUESTO']; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
								<td></td>
							</tr>
						<?php } ?>
					</tbody>
