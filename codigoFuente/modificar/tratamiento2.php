...
<?php
	...
	if(!empty($_POST))
	{
		$valor = $_POST['campo'];
		if(!empty($valor)){
			$where = "WHERE ID_TRATAMIENTO LIKE '%$valor'";
		}
	}
	$sql = "SELECT * FROM tratamientos $where";
					...
					<tbody>
						<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
							<tr>
								...
								<td><a href="modificar_tratamiento.php?ID_TRATAMIENTO=<?php echo $row['ID_TRATAMIENTO']; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
								<td></td>
							</tr>
						<?php } ?>
					</tbody>
