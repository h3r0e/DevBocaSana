...
<?php
	...
	$DESCRIPCION_CITA = $_POST['DESCRIPCION_CITA'];
	$FECHA_CITA = $_POST['FECHA_CITA'];
	$HORA_CITA = $_POST['HORA_CITA'];
	
	$sql = "UPDATE agenda SET DESCRIPCION_CITA='$DESCRIPCION_CITA', FECHA_CITA='$FECHA_CITA', HORA_CITA='$HORA_CITA' WHERE ID_CITA = '$ID_CITA'";
