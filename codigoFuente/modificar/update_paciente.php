...
<?php
	...
	$sql = "UPDATE pacientes SET NOMBRE_APELLIDO='$NOMBRE_APELLIDO', NACIONALIDAD='$NACIONALIDAD', DIRECCION='$DIRECCION', TELEFONO='$TELEFONO' WHERE DNI_PACIENTE = '$DNI_PACIENTE'";
